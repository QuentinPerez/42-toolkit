...
/*   Updated: 2013/11/11 17:15:08 by cmuller          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool	uf_matrix_fillcoeff(t_matrix *v_this, ui col)
{
	ui	i;
...
bool		f_matrix_init(t_matrix *v_this, ui c, ui r)
{
	...
	v_this->v_coeff = malloc(sizeof(*(v_this->v_coeff)) * r);
	if (v_this->v_coeff == NULL)
		return (m_error(false, "Bad alloc"));
	if (uf_matrix_fillcoeff(v_this, c) == false)
		return (false);
	v_this->v_columns = c;
	v_this->v_rows = r;
	return (true);
