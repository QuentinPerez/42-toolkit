...
function!	Insert_header_add_info(begin, end, nul_line, setline)
...
function!	Insert_header_add_mail()
...
function!	Insert_header_add_file()
	let l:line = "/*   "
	let l:file = expand('%:f')
...
function!	Insert_header()
	...
	call append(1, "/*                                                                            */")
	call append(2, "/*                                                        :::      ::::::::   */")
	call Insert_header_add_file()
	call append(4, "/*                                                    +:+ +:+         +:+     */")
	call Insert_header_add_mail()
	call append(6, "/*                                                +#+#+#+#+#+   +#+           */")
	call Insert_header_add_info("Created", " #+#    #+#             */", 7, 0)
