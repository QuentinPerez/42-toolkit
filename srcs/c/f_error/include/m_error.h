...
/*
** <This function contains all error prototype>
...
# define m_error_infos(str_inf)	fm_error_infos(__func__, str_inf)
...
void	fm_error_infos(const char *infos, const char *err);
